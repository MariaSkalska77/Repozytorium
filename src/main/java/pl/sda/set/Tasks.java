...
//        //#1
//        Citizen citizen1 = new Citizen("Jan1", "Kowalski", "850223000000");
...
//
//        //#2
//        Car car1 = new Car("honda", "black", 104153);
//        Car car2 = new Car ("toyota", "blue", 541343);
//        Car car3 = new Car ("honda", "red", 331443);
//        setOfCars(car1, car2, car3); //przekazujemy obiekty do metody
//
//        //#3
...
////
////        Set<Citizen> setcitizenow = new HashSet<>();
////        setcitizenow.addAll(Arrays.asList(citizens));
////        System.out.println(setcitizenow);
////
////        //varargs to tablica
//////        setcitizenow.add(citizen);
////
//////        setcitizenow.addAll(setcitizenow);
////    }
//
//    /**
...
//        Set<Car> setcarow = new HashSet<>();
//        setcarow.addAll(Arrays.asList(cars));
//        System.out.println(setcarow);
//        //ctrl + p - sprawdzamy co metoda przyjmuje
//    }
//
//    /**
...
//        NavigableSet<Citizen> setCitizenow = new TreeSet<>();
//        setCitizenow.addAll(Arrays.asList(citizens));
//        return setCitizenow;
//    }
//
