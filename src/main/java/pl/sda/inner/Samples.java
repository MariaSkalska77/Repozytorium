...
//               Product.ByNameReversed byNameReversed = new Product.ByNameReversed();
        ...
        Comparator<Product> lambda = (o2, o1)-> o2.getName().compareTo(o1.getName());//odwrotna kolejnosc sortowania
        ...
        //predicate jest interfejsem fukcyjnym - ma jedna metode i mozemy stworzyc z niego lambde
